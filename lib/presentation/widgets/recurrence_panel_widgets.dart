...
recurrencePanel(BuildContext context) {
  final HabitRecurrenceCubit habitRecurrenceCubit =
      context.read<HabitRecurrenceCubit>();
  ...
  Map<int, bool> savedMonthDays =
      Map.from(habitRecurrenceCubit.state.monthDays);
  Map<String, bool> savedWeekDays =
      Map.from(habitRecurrenceCubit.state.weekDays);
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              const Padding(
                ...
                child: Divider(height: 1, color: Color.fromRGBO(82, 82, 82, 1)),
              ),
              BlocBuilder<HabitRecurrenceCubit, HabitRecurrenceState>(
                builder: (context, state) {
                  bool interval = state.pages['interval']!;
                  ...
                  SaveRecurrenceButton(onTap: () {
                    if (context
                      ...
                      String value = context
                          ...
                          .state
                          .recurrenceValue;
                      HabitRecurrenceCubit defaultRecurrenceValues =
                          HabitRecurrenceCubit();
                      context.read<HabitFormCubit>().setHabitRecurrence(value);
                      habitRecurrenceCubit
                          .setWeekDays(defaultRecurrenceValues.state.weekDays);
                      habitRecurrenceCubit
                          .setMonthDays(defaultRecurrenceValues.state.monthDays);
                    }
                    if (context
                        .read<HabitRecurrenceCubit>()
                        .state
                      ...
                      context
                          .read<HabitFormCubit>()
                          .setHabitRecurrence('Custom W.');
                      HabitRecurrenceCubit defaultRecurrenceValues =
                          HabitRecurrenceCubit();
                      habitRecurrenceCubit
                          .setMonthDays(defaultRecurrenceValues.state.monthDays);
                      habitRecurrenceCubit.setRecurrenceValue(
                          defaultRecurrenceValues.state.recurrenceValue);
                    }
                    if (context
                        .read<HabitRecurrenceCubit>()
                        .state
...
class SetInterval extends StatelessWidget {
  final String value;
  final int? number;
  const SetInterval({super.key, required this.value, this.number});
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: SizedBox(
        ...
        child: Row(
          children: <Widget>[
            Text(value == 'Every Day' ? value : 'Every',
            style: const TextStyle(
                color: Colors.white,
                fontWeight: FontWeight.w500,
                fontSize: 14)
            ),
            number != null ? Text(" ${number.toString()} ",
            style: const TextStyle(
                color: Colors.white,
                fontWeight: FontWeight.w600,
                fontSize: 14)
            ) : Container(),
            number != null ? const Text('Days',
            style: TextStyle(
                color: Colors.white,
                fontWeight: FontWeight.w500,
                fontSize: 14)
            ...
            child: Row(children: [
              Column(
                children: <Widget>[
                  ...
                  SetInterval(value: 'Every 5 Days', number: 5),
                  SetInterval(value: 'Every 6 Days', number: 6),
                  SetInterval(value: 'Every 7 Days', number: 7),
                ],
              ),
            ]),
          ), ]
            ...
            SizedBox(
              ...
              child: BlocBuilder<HabitRecurrenceCubit, HabitRecurrenceState>(
                builder: (context, state) {
                  ...
                  return Checkbox(
                      //TODO make the check boxes easier to click, something like a gesture detector for the whole line
                      value: weekDays[day],
              ...
              children: [
                Column(
                  children: [
                    ...
                    for (String day
                        in context.read<HabitRecurrenceCubit>().state.weekDays.keys)
                              ...
                              onPressed: () {
                                ...
                                if (isSafe) {
                                  ...
                                  if (hasOtherKeys) {
                                    context
                                        .read<HabitRecurrenceCubit>()
                                        .monthDaysRemove(index + 1);
                                  } else {
                                  }
                                } else {
                                  context
                                      .read<HabitRecurrenceCubit>()
                                      .monthDaysAdd(index + 1);
                                }
                                //print(monthDays);
                              },
                              child: FittedBox(
    ...
    return BlocBuilder<HabitFormCubit, HabitFormState>(
      builder: (context, state) {
        ...
        if (state.recurrenceSet.length <= counter) {
          recurrenceTextFull =
              state.recurrenceSet.substring(0, state.recurrenceSet.length);
        } else {
          recurrenceTextFull =
              "${state.recurrenceSet.substring(0, counter)}...";
        }
        return Padding(
